...
$api = 'https://masak-apa-tomorisakura.vercel.app/api/categorys/recipes/resep-ayam';
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-link active " aria-current="page" href="ayam.php">Resep Ayam</a>
        ...
        <div class="col-md-4">
          <div class="card shadow p-3 mb-3 bg-body rounded mx-auto " style="width:20rem;">
            ...
            <div class="card-body">
              ...
              <p>Porsi : <?= $row["portion"]; ?></p>
              <p>Kesulitan : <?= $row["dificulty"]; ?></p>
