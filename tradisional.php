...
$api = 'https://masak-apa-tomorisakura.vercel.app/api/categorys/recipes/masakan-tradisional';
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-link active " aria-current="page" href="tradisional.php">Masakan Tradisional</a>
          </div>
        </div>
      </div>
    </nav>
